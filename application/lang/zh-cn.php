...
//            3 => array('id' => 3, 'name' => '待收货'),
    ...
    'common_assure_style_list' => array(
        1 => array('value' => 1, 'name' => '平台担保', 'tg' => ''),
        2 => array('value' => 2, 'name' => '卡尔担保', 'tg' => 'CARL789'),
        3 => array('value' => 3, 'name' => '老王担保', 'tg' => 'BAOWW'),
    ),

    'common_goods_type_list' => array(
        1 => array('value' => 1, 'name' => '需求', 'color' => 'green'),
        2 => array('value' => 2, 'name' => '供应', 'color' => 'red'),
    ),
    ...
    //商品审核状态
    'common_goods_check_status' => [
        0 => array('value' => 0, 'name' => '待审核'),
        1 => array('value' => 1, 'name' => '审核通过'),
        2 => array('value' => 2, 'name' => '审核被拒'),
    ],
    //投诉原因列表
    'common_exposure_reason_list' => [
        1 => array('value' => 1, 'name' => '骗钱'),
        2 => array('value' => 2, 'name' => '忽悠'),
        3 => array('value' => 3, 'name' => '不真实'),
    ],


    'common_is_able_list' => array(
        0 => array('id' => 0, 'name' => '不启用'),
        1 => array('id' => 1, 'name' => '启用', 'checked' => true),
    ),
);

...
class Safety extends Common
{
     ...
     * @return mixed
     */
    public function payPwdInfo()
    {
        // 浏览器名称
        $this->assign('home_seo_site_title', SeoService::BrowserSeoTitle('支付密码修改 - 安全设置', 1));
	...
	public function payPwdUpdate()
	{
		...
		return SafetyService::PayPwdUpdate($params);
	}

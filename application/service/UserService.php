...
//            ],
    ...
    public static function autoRegisterWhenSpeak($speakMessage)
    {
        ...
        if (empty($user) && isset($speakMessage['from']['username'])) {


            $save = [
                'admin'            => ['id' => '1'],
                'username'         => $speakMessage['from']['username'],
                'nickname'         => $speakMessage['from']['first_name'],
                'user_telegram'    => $speakMessage['from']['username'],
                'pwd'              => '123456',
                'gender'           => '0',
                'status'           => '0',
                'integral'         => 0,

...
//                ],
                ...
                [
                    ...
                    'search_config' => [
                        'form_type'         => 'select',
                        'where_type'        => 'in',
                        'data'              => lang('common_goods_check_status'),
                        'data_key'          => 'value',
                        'data_name'         => 'name',
                        'is_multiple'       => 0,
                    ],
...
//                    'label'         => '担保方式',
//                    'view_type'     => 'field',
//                    'view_key'      => 'assure_style',
//                    'view_data_key' => 'name',
//                    'view_data'     => lang('common_assure_style_list'),
//                    'search_config' => [
//                        'form_type'         => 'select',
//                        'where_type'        => 'in',
//                        'data'              => lang('common_assure_style_list'),
//                        'data_key'          => 'value',
//                        'data_name'         => 'name',
//                        'is_multiple'       => 1,
//                    ],
//                ],
                ...
                [
                    ...
                    'search_config' => [
                        'form_type'         => 'select',
                        'where_type'        => 'in',
                        'data'              => lang('common_goods_type_list'),
                        'data_key'          => 'value',
                        'data_name'         => 'name',
                        'is_multiple'       => 1,
                    ],

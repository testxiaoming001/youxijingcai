...
use app\service\TgbannerService;
...
class Tgbanner extends Common
{
    ...
    {
        // 总数
        $total = TgbannerService::TgbannerTotal($this->form_where);
        ...
        $page_params = [
            ...
            'page' => $this->page,
            'url' => MyUrl('admin/tgbanner/index'),
        ];
        ...
        $ret = TgbannerService::TgbannerList($data_params);
    ...
    public function Save()
    {
        ...
        // 开始处理
        $params = $this->data_request;
        return TgbannerService::TgbannerSave($params);
    }
    ...
    public function Delete()
    {
        ...
        return TgbannerService::TgbannerDelete($params);
    }

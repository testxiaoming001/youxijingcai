...
class RechargeService
{
    ...
    public static function RechargeCreate($params = [])
    {
        ...
        // 是否开启充值
        if(!empty($plugins_base) && isset($plugins_base['is_enable_recharge']) && $plugins_base['is_enable_recharge'] == 0)
        {
        ...
        $p = [
            ...
            [
                'checked_type'      => 'empty',
                'key_name'          => 'reacharge_usdt_address',
                'error_msg'         => '请输入充值usdt地址',
            ],
        ];
        ...
        $data = [
            ...
            'status'        => 0,
            'add_time'      => time(),
            'reacharge_usdt_address'      => $params['reacharge_usdt_address'],
            'by_reacharge_usdt_address'      => $params['by_reacharge_usdt_address'],

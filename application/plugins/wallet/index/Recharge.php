...
class Recharge extends Common
{
    ...
    public function __construct()
    {
        ...
        $this->assign('home_site_wallet_units',$home_site_wallet_units);
    }
    ...
    public function index($params = [])
    {
        ...
        // 浏览器名称
        $this->assign('home_seo_site_title', SeoService::BrowserSeoTitle('充值明细 - 我的钱包', 1));



        //匹配一个充值地址
        $this->assign('receiptAddress',ReceiptService::getReceiptAddress());
